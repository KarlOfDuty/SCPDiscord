        ...
        public static async Task Init()
        {
            try
            {
                ...
                if (!ConfigParser.config.bot.disableCommands)
                {
                    ...
                    instance.commands.RegisterCommands<Commands.BanCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.HelpCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.KickAllCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.KickCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.ListCommand>(ConfigParser.config.bot.serverId);
                    //instance.commands.RegisterCommands<Commands.ListRankedCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.ListSyncedCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.MuteCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.PlayerInfoCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.RACommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.ServerCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.SyncIPCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.SyncSteamIDCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.UnbanCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.UnmuteCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.UnsyncCommand>(ConfigParser.config.bot.serverId);
                    instance.commands.RegisterCommands<Commands.UnsyncPlayerCommand>(ConfigParser.config.bot.serverId);
